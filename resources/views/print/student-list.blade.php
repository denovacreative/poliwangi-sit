                    ...
                    <td colspan="2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div align="center" class="style1"><strong>DAFTAR MAHASISWA</strong></div>
                                    </td>
                                </tr>
                                <tr>
                                </tr>
                                    ...
                                    <td colspan="2">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td width="18%">STATUS MAHASISWA</td>
                                                <td style="text-transform: capitalize">: {{ $header['student_status'] }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="15%">JALUR MASUK</td>
                                                <td  style="text-transform: capitalize">: {{ $header['registration_path'] }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                                        ...
                                                        <table width="100%" border="1" cellspacing="0">
                                                            <tbody>
                                                                <tr bgcolor="#A8EEFF" id="render">
                                                                    ...
                                                                    <td width="3%">
                                                                        <div align="center"><strong>JK</strong></div>
                                                                    </td>
                                                                    <td width="2%">
                                                                    ...
                                                                    <td width="5%">
                                                                        <div align="center"><strong>Kelas</strong></div>
                                                                    </td>
                                                                    <td width="5%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style=" font-size: 10px;" >{{ $item->nim }}</td>
                                                                    <td style=" font-size: 10px;">{{ $item->name }}</td>
                                                                    @if ($item->gender == 'L')
                                                                    <td style=" font-size: 10px; text-align: center;">LAKI - LAKI</td>
                                                                    @else
                                                                    <td style=" font-size: 10px; text-align: center;">PEREMPUAN</td>
                                                                    @endif
                                                                    <td style=" font-size: 10px; text-align: center;">{{ $item->religion->name }}</td>
                                                                    @if ($item->classGroup == null)
                                                                    <td style=" font-size: 10px; text-align: center;">{{ '-'}}</td>
                                                                    @else
                                                                    <td style=" font-size: 10px; text-align: center;">{{ $item->classGroup->name }}</td>
                                                                    @endif
                                                                    <td style=" font-size: 10px;">{{ $item->birthplace }}, {{ $item->birthdate }}</td>
                                                                    <td style=" font-size: 10px;">{{ $item->street }}</td>
                                                                </tr>
                                                                @php
                                                                    $i++;
                                                                @endphp
