    ...
    ! function () {
        ...
        function B() {
            ...
            Array.from(n).forEach(function (e, t) {
                if($('#sidebarMore').length <= 0) {
                    t + 1 === a && (s = e), a < t + 1 && (o += e.outerHTML, e.remove()), t + 1 === n.length && s.insertAdjacentHTML && s.insertAdjacentHTML("afterend", '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i class="ri-windows-line"></i> Selengkapnya\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' + o + "</ul></div>\t\t\t\t\t</li>")
                }
            })
        }
